...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression','main.py',44),
  ('expression -> expression MINUS term','expression',3,'p_expression','main.py',45),
  ('expression -> term','expression',1,'p_expression','main.py',46),
  ('term -> term TIMES factor','term',3,'p_term','main.py',58),
  ('term -> term DIVIDE factor','term',3,'p_term','main.py',59),
  ('term -> factor','term',1,'p_term','main.py',60),
  ('factor -> NUMBER','factor',1,'p_factor','main.py',72),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','main.py',73),
]
